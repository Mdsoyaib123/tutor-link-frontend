...
const DetailsProfiles = ({ tutor }: { tutor: IUser | null }) => {
  ...
  const fetchReviews = async () => {
    if (!tutor?._id) return; // Check if tutor ID is available
  ...
  return (
    <div>
      ...
      <div className="rounded-lg my-6 ">
        <h2 className=" text-xl  md:text-3xl  font-bold leading-snug  text-center">
            ...
            <TabsContent value="about">
              ...
              <div className="my-6 flex gap-12 ">
                <div>
                  ...
                  <ul className="list-disc text-gray-500 marker:text-green-600 px-6 marker:text-2xl">
                    <li>
                      Master`s in   {tutor?.subjects?.split(",").map((subject, index) => (
                    <span
                      key={index}
                      className=""
                    >
              ...
              <div className="my-6">
                ...
                <h2 className=" text-gray-500 text-sm font-semibold mt-1 flex items-center gap-2">
                  <MapPinHouse size={18} />
                  {tutor.address||"N/A" } 
                </h2>
              </div>
