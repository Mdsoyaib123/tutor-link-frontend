    ...
    return (
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          ...
          <div>
           ...
           <Link href = {"/tutors"}> <button className="bg-blue-600 text-white px-6 py-2 rounded-md hover:bg-blue-700 transition">
              Get Started
            </button></Link>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12 max-w-7xl mx-auto">
          {[
            ...
            { icon: '💬', title: 'Interactive Learning', desc: 'Engage through live chats, quizzes & more.' },
          ].map((card, i) => (
            <div
              key={i}
              className="bg-white rounded-xl shadow-md hover:shadow-lg shadow-blue-600 p-6 text-center transition-all"
            >
